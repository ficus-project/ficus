...
export default class InfluxService {
  ...
  public getVirtualMachinesConsumptionMetrics(start: DateTime, stop: DateTime, window: string = '1d', aggregator: EAggregateFunctions = EAggregateFunctions.MEAN): Observable<IInfluxConsumptionMetric> {
    const fluxQuery =
